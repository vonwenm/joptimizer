...
public class NewtonLEConstrainedFSPTest extends TestCase {
	...
	public void testOptimize() throws Exception {
		...
		assertEquals(0.04632311555988555, sol[0], 0.0000000000000001);
		assertEquals(0.5086308460954377,  sol[1], 0.0000000000000001);
		assertEquals(0.44504603834467693, sol[2], 0.0000000000000001);
	}
